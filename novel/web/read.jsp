...
<body>
        ...
        <div class="row">
            ...
            <div>
                <%
                    ...
                    File list_file = new File(BASE_PAtH);
                    File[] file_list = list_file.listFiles();
                    total_chpater = file_list.length;
                ...
                -->
                <div>
                    <a href="BookInfo/<%=novel_id%>" class="info-self-a" id="glyphicon-book-name">
            ...
            <div id="content-context">
                <%
                    String BASE_PAtHs = "D:\\java_homework\\qishu_book\\" + novel_type + "\\" + novel_name;
                    ...
                    while(content != null){
                        if(content.length() != 0)
                            out.println("<p style=\"text-indent:2em\">"+content+"</p>");
    ...
    <%
        ...
        // out.println("asdf:"+total_chpater);
        if(present_chapter == (total_chpater-3))
            next_url = "javascript:;";
        else
    ...
    <div class="container" id="footer-container" style="margin-bottom: 20px">
        <div class="row" id="footer-row">
            <div style="padding-left: 0;padding-right: 0">
                <a href="<%=pre_url%>" class="footer-link" id="pre_chapter">上一章</a><span>|</span><a href="<%=chapter_list%>" class="footer-link">目录</a><span>|</span><a href="<%=next_url%>" class="footer-link" id="next_chapter">下一章</a>
            </div>
        </div>
    </div>
