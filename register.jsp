            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a href="/novel/register.jsp">注册</a></li>
                        <li><a href="#">登录</a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
            ...
            <div class="col-md-9">
                <div>
                    <form action="#">
                        ...
                        <div class="form-group">
                            <label for="" type="ComfirmPassword">确认密码</label>
                        ...
                        <button class="btn btn-success" type="submit" disabled="disabled" id="register">确认</button>
                    </form>
                </div>
            </div>
